...
from datasets.cct20 import cct20
...
for split in ['trainval', 'test', 'testtrans', 'testing_test', 'testing_small']:
    name = 'cct20_{}'.format(split)
    __sets[name] = (lambda split=split: cct20(split))
